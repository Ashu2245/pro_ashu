...
var {Dimensions, StyleSheet, Text, View} = require('react-native');
...
var Carousel = React.createClass({
    ...
    renderPageIndicator() {
        ...
        var indicators = [],
            indicatorStyle = this.props.indicatorAtBottom
                ? {
            ...
            indicators.push(
                <Text style={[
                    ...
                    {i === this.state.activePage
                        ...
                        : this.props.inactiveIndicatorText}
                </Text>
            );
        }
    ...
    render() {
        return (
            <View style={{
                ...
                <CarouselPager ref="pager" width={this.getWidth()} contentContainerStyle={styles.container} onBegin={this._onAnimationBeginPage} onEnd={this._onAnimationEnd}>
                    {this.props.children}
                </CarouselPager>
